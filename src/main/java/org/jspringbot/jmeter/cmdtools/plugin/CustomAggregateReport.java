package org.jspringbot.jmeter.cmdtools.plugin;
 ...
 * @see StatVisualizer
 */
public class CustomAggregateReport extends AbstractGraphPanelVisualizer {
    ...
    public String getLabelResource() {
        return "custom_aggregate_report";
    }
